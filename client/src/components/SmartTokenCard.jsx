...
export default function SmartTokenCard() {
  ...
  return (
    <div className="bg-white rounded-3xl border-2 border-emerald-500/20 shadow-[0_8px_30px_rgb(0,0,0,0.08)] p-6 sm:p-7 flex flex-col justify-between hover:shadow-[0_12px_40px_rgb(0,0,0,0.12)] transition-shadow relative overflow-hidden">
